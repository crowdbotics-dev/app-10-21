"""
Django settings for app_10_21 project.
...
WSGI_APPLICATION = 'app_10_21.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "app_10_21 API",
    "DESCRIPTION": "API documentation for app_10_21 App",
    "VERSION": "v1",
}
